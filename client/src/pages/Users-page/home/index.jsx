...
function UserViewHomePage() {
  ...
  return (
    <section
      className="relative min-h-screen  py-10 sm:pt-20 lg:pt-2 overflow-hidden"
      id="home"
    >
      {/* Event Date */}
      ...
      <div className="absolute z-20 inset-0 h-full w-full bg-white sm:mt-10 md:mt-10 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_40%,#000_60%,transparent_100%)]">
        <div className="flex flex-col items-center justify-center gap-6">
          {/* Logo */}
          <div className="flex justify-center items-center w-56 h-56 lg:mt-0 shadow-2xl rounded-full p-3 bg-white">
            <img
              src={logo}
          ...
          <div className="text-center flex flex-col sm:gap-2">
            <h3 className="font-title text-5xl sm:text-6xl md:text-7xl lg:text-5xl text-red-600 tracking-wide">
              Kannur University
            </h3>
            <h4 className="font-title text-5xl md:text-6xl lg:text-4xl text-red-600 tracking-wide">
              Union Arts Festival
            </h4>
            <h5 className="font-title text-4xl md:text-5xl lg:text-3xl mt-2">
              2023 - 24
            </h5>
            <h6 className="font-title text-4xl text-red-600 md:text-5xl lg:text-3xl tracking-wide mt-2">
      ...
      {announcementList && announcementList.length > 0 && (
        <div
          className="absolute bottom-2 sm:bottom-28 md:bottom-24 lg:bottom-0 w-full flex justify-center overflow-hidden text-white text-2xl sm:text-3xl p-3"
          style={{
            WebkitMask:
