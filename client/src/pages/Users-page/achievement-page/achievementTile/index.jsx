  ...
  return (
    <div className="relative  group  border-sky-900 border-4  rounded-2xl  bg-sky-800 px-3 py-2 flex flex-col items-start gap-3">
      ...
      <div className="text-gray-50 mb-8">
        ...
        <p className="text-md mt-2 border-l-4 border-white pl-2 leading-6   ">
        ...
        <p className="text-md mt-2 border-l-4 sm:text-xl  border-white pl-2   ">
          <p className="font-bold text-sky-300 ">{achievement?.collegeName}</p>
        </p>
      </div>
    </div>
  );
